...
#define Mtolua_new(TYPE, EXP) new(LuaWrap::Malloc(sizeof(TYPE))) EXP
#define Mtolua_delete(TYPE, OBJ) { OBJ->~TYPE(); LuaWrap::Free(OBJ, 0); }
#undef Mtolua_new_dim		/*unsupport*/
#undef Mtolua_delete_dim	/*unsupport*/
#else
#ifndef Mtolua_new
